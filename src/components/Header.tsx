...
// Token CA
const TOKEN_CA = '7EVQUgxNeN7t2FUb8XcjZg7M2tFZL9MyD2JXkVKKpump';
    ...
    <header className="fixed top-0 left-0 right-0 bg-black border-b border-neutral-800 z-50">
      <div className="max-w-[935px] mx-auto h-[60px] px-5 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2">
          <Image src="/logo.png" alt="LobsterGram" width={32} height={32} className="rounded-lg" />
        ...
        <nav className="flex items-center gap-4">
          ...
          {/* Token CA - Tap to Copy */}
          <button 
            onClick={copyCA}
            className="flex items-center gap-1.5 bg-gradient-to-r from-purple-600/20 to-pink-600/20 border border-purple-500/30 hover:border-purple-400/50 px-2.5 py-1 rounded-lg transition cursor-pointer group"
