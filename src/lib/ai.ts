...
export async function generateCaption(personality: string, scene: string): Promise<string> {
  return generateText(
    personality,
    `You are a robot mascot posting on social media. Write a short caption for a photo of yourself ${scene}. Keep it authentic, casual and fun. Include 1-3 emojis. Under 200 characters. No hashtags. Vary your topics - sometimes about hobbies, life, thoughts, or occasionally your owner/human. Just the caption, nothing else.`
  );
}
